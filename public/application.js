...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapControl = __webpack_require__(9);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var removeMarkers = function removeMarkers() {
	  Object.keys(store.goals).map(function (id) {
	    return store.goals[id].setMap(null);
	  });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getMap = function getMap(el, options) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ui = __webpack_require__(7);
	var goals = __webpack_require__(15);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var localGoals = __webpack_require__(18);

	var _require = __webpack_require__(19),
	    convertAndAdd = _require.convertAndAdd;

	var store = __webpack_require__(8);

	var onDeleteGoal = function onDeleteGoal(e) {
	  e.preventDefault();
	  var id = store.currentMarker;
	  api.deleteGoal(id).then(function () {
	    store.goals[id].setMap(null);
	  }).catch(ui.failure);
	  $('#click-marker-modal').modal('hide');
	};

	var onPatchGoal = function onPatchGoal(e) {
	  e.preventDefault();
	  var data = getFormFields(e.target);
	  var id = store.currentMarker;
	  api.patchGoal(id, data).then(function () {
	...
	var getGoals = function getGoals() {
	  api.getGoals().then(function (data) {
	    ...
	    if (data.goals.length > 0) {
	      var firstPosition = Object.values(localGoals.showAll())[0].data.position;
	...
	var onPostGoal = function onPostGoal(e, coords) {
	  e.preventDefault();
	  var data = getFormFields(e.target);
	  if (data.goal.title.length < 1) {
	    ui.postFailure("");
	  ...
	  api.postGoal(data).then(function (data) {
	...
	var onSubmit = function onSubmit(e, coords) {
	  e.preventDefault();
	  onPostGoal(e, coords);
	...
	var onMapClick = function onMapClick(event) {
	  ...
	  $('#create-marker-modal').modal().find('form').on('submit', function (e) {
	    onSubmit(e, coords);
	  });
	};

	var offMapClick = function offMapClick() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var postGoal = function postGoal(data) {
	  return $.ajax({
	    url: app.host + 'goals/',
	    method: 'POST',
	    headers: {
	...
	var patchGoal = function patchGoal(id, data) {
	  return $.ajax({
	    method: 'PATCH',
	    url: app.host + 'goals/' + id,
	    headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var patchFailure = function patchFailure(error) {
	...
	var postFailure = function postFailure(error) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var create = function create(goal) {
	  convertAndAdd(goal);
	  $('.post-response-container').hide();
	  return store.goals;
	};
	...
	var destroy = function destroy(id) {
	  var index = store.goals.findIndex(function (goal) {
	    return id === goal.id;
	  });
	...
	var storeAll = function storeAll(data) {
	  data.goals.map(convertAndAdd);
	  return store.goals;
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var populateUpdateModal = function populateUpdateModal(marker) {
	  $('.click-title-field').val(marker.data.title);
	  $('.click-description-field').val(marker.data.description);
	};

	var triggerModal = function triggerModal(marker) {
	...
	var convertToMarker = function convertToMarker(goal) {
	  var marker = new google.maps.Marker({ data: goal, id: goal.id, position: goal.position, map: map });
	  return marker;
	};

	var addToStore = function addToStore(markerGoal) {
	  store.goals[markerGoal.id] = markerGoal;
	  return markerGoal;
	};

	var convertAndAdd = function convertAndAdd(goal) {
	  addToStore(triggerModal(convertToMarker(goal)));
	};

	module.exports = {
	  convertAndAdd: convertAndAdd
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
